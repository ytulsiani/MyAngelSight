...
def main():
    ...
    my_cascade = haarCascade("./deepgaze/haarcascade_frontalface_alt.xml", "./deepgaze/haarcascade_profileface.xml")
    #TODO If missing, example file can be retrieved from http://dlib.net/files/shape_predictor_68_face_landmarks.dat.bz2
    my_detector = faceLandmarkDetection('./deepgaze/shape_predictor_68_face_landmarks.dat')
